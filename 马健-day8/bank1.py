import random,time
from bank1.User1 import User
from bank1.Money1 import Money
from bank1.Interface1 import Interface
from bank1.Address1 import Address


def inquire():
    file = open("usertext.txt", "r+", encoding="utf-8")
    a = Money()
    account = input("请输入账号：")
...
def addUser():
    ...
    status = c.bank_addUser(a.getAccount(),
                            a.getUsername(),
                            a.getPassword(),
                            a.getMoney(),
                            a.getTime(),
